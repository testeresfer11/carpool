...
<div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Demand Forecasting Insights</h4>
            <canvas id="bookingTrendChart"></canvas>
             <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script>
        const bookingTrend = @json($responseData['bookingTrendChartData']);
...
<div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Loyal Customers (Past 30 Days)</h4>
            <canvas id="loyalCustomersChart"></canvas>
            <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script>
        const loyalData = @json($responseData['loyalCustomerChartData']);
        new Chart(document.getElementById('loyalCustomersChart'), {
        type: 'bar',
        data: loyalData,
        options: {
            responsive: true,
...
<div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Top Pickup Locations</h4>
...
<div class="col-lg-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Top Drop Locations</h4>
            <canvas id="dropLocationChart"></canvas>
        </div>
    </div>
</div>
</div>
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <canvas id="promoChart" style="max-width: 600px;"></canvas>
            </div>
        </div>
    </div>
</div>
...
function renderPieChart(data) {
    ...
    const pickupData = @json($responseData['pickupLocationChartData']);
    new Chart(document.getElementById('pickupLocationChart'), {
        type: 'pie',
        data: pickupData,
        options: {
            responsive: true,
    ...
    const dropData = @json($responseData['dropLocationChartData']);
    new Chart(document.getElementById('dropLocationChart'), {
        type: 'pie',
        data: dropData,
        options: {
            responsive: true,
    ...
    const promoData = @json($responseData['promoChartData']);
  new Chart(document.getElementById('promoChart'), {
    ...
    options: {
      ...
      plugins: {
        title: { display: true, text: 'Upcoming Holidays & Events by Month' },
