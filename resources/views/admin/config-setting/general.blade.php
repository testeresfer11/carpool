                    ...
                    <form class="forms-sample" id="edit-user" action="{{ route('admin.settings.general')}}" method="POST" enctype="multipart/form-data">
                       ...
                       {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="rewardValue">Reward Points</label>
                                    <input type="number" min="0" class="form-control @error('total_reward_points') is-invalid @enderror" id="rewardValue" placeholder="Enter Reward Points" name="total_reward_points" @if(!empty($general)) value="{{ old('total_reward_points', $general->total_reward_points) }}" @endif>
                                    @error('total_reward_points')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" min="0" step="0.01" class="form-control @error('points_value') is-invalid @enderror" id="points_value" placeholder="Enter Points Value" name="points_value" @if(!empty($general)) value="{{ old('points_value', $general->points_value) }}" @endif>
                                    @error('points_value')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
    ...
    $(document).ready(function() {
        $("#edit-user").validate({
            ...
            messages: {
                ...
                total_reward_points: {
                    required: "Total reward points is required",
                    number: "Please enter a valid number",
                    min: "Total reward points must be at least 0",
                    noSpace: "No spaces allowed",
                },
                points_value: {
                    required: "Points value is required",
                    number: "Please enter a valid number",
                    min: "Points value must be at least 0",
                    noSpace: "No spaces allowed",
                }
            },
            errorElement: 'span',
