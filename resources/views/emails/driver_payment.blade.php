            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style=" max-width:522px;color: #231f20; font-weight: 600;">Your transfer will arrive in your account in approximately 5<br> business days.</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">It will appear as “Drivvy payment“.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="date-text">
                                <h5 style="font-size: 18px; color: #666666; font-weight: 600;">
                                <span style="color:#666666;font-weight: 600;">{{ \Carbon\Carbon::parse($ride->departure_time)->format('F j') }}.</span>
                                <a href="#" style="color:#666666; text-decoration: none;"><span style="padding: 0 10px;color:#666666;font-weight:600"> {{ $ride->departure_city }}  </span></a>   >   <a href="#"style="color:#666666;text-decoration: none;"><span style="padding-left:10px;color:#666666;font-weight: 600;">{{$ride->arrival_city }}</span><a> </h5>
                              </div>
                        </td>
                    </tr>
                   <tr>
                        <td>
                            <div class="jone">
                                <h5 style="font-size:18px;color: #808080;font-weight:500;margin: 0; display: inline-block;">Transfer made on</h5>
                                
                                <span style="margin-left: 270px; color: #666666; font-size: 18px; font-weight: 700;">
                                    ${{ number_format($finalPayoutAmount, 2) }}
                                </span>
                            </div>
                        </td>
                    </tr>
                      <tr>
                        <td>
                            <div class="jone">
                                ...
                                <h5 style="font-size:18px;color: #808080;margin: 0; display: inline-block; padding-left: 10px;font-weight: 500;">
                                    {{ \Carbon\Carbon::parse($ride->created_at)->format('F j') }}
                                </h5>
