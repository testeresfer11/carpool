...
<head>
    ...
    <title>Passenger-booked-ride</title>
            ...
            <table style="width: 100%;">
               ...
               <tbody>
                   <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20; font-weight: 600;">A passenger wants to book your ride.</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td style="text-align: center;">
                            <div class="total-pass" style="margin:30px 0;">
                                <span style="margin: 0; color: #666666; font-size: 18px;">Total paid by the passenger</span><span
                                    style="margin: 0; color: #666666; font-size: 18px;font-weight: 700;padding-left: 30px;">$ {{ ($amount) }}</span>
                            </div>
                        </td>
                    </tr>
                        </table>
