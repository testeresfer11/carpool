            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style=" max-width:522px;color: #231f20; font-weight: 600;">Your transfer details has been updated </h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">Your transfer details has been updated on {{ $updatedDate }}.</p>
                        </td>
                    </tr>
                    
                    <tr>
                        <td>
                            <p style="margin-bottom: 40px;font-size: 18px; color: #808080;background-color: #f9f9f9; padding: 30px;">If you have not made this change. Please contact us by responding to this email.</p>
                        </td>
                    </tr>
                      <tr>
