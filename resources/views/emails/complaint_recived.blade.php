            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20;  font-weight: 600;">We've received a complaint regarding your ride</h1>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">There has been a complaint regarding your ride. We will review its validity before processing your payment.</p>
                        </td>
                    </tr>
