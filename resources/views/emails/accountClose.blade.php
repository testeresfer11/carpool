            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20;font-weight: 600;">Your account has been successfully closed</h1>
                        </td>
                    </tr>
                    
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">We are sorry to see you go.We hope you join the Drivvy community again.</p>
                        </td>
                    </tr>
                      <tr>
