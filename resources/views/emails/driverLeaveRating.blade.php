            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20; font-weight: 600;">How was your ride with {{$user->first_name}}?</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">Please, rate your ride with {{$user->first_name}} and leave a review.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top:25px; padding-bottom:25px;">
                            ...
                            <span style="padding-left: 100px; vertical-align: middle;">
                                <img src="{{ $user->profile_picture ? url('/storage/users/' . $user->profile_picture) : asset('/admin/images/user-image.webp') }}" 
