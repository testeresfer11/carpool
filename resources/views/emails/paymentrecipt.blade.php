            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20;  font-weight: 600;">Here are the details of your payment.</h1>
                        </td>
                    </tr>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td style="text-align: right;">
                                    <div class="total-pass" style="margin:40px 0;">
                                        <span style="font-size: 18px; color: #808080;">Total</span>
                                       <span style="margin: 0; color: #666666; font-size: 18px;font-weight: 700;padding-left: 30px;">${{ number_format($payment->amount, 2) }}</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="border-top: 1px solid #dee2e6;padding-top: 40px;padding-bottom: 40px;">
                                    <div class="trasaction">
                                        <h5 style="margin: 0; color: #666666; font-size: 18px;font-weight: 600;">Transaction details</h5>
                                        <p style="font-size: 18px; color: #808080; margin: 0;">
                                         <span>{{ \Carbon\Carbon::parse($payment->created_at)->format('d.m.Y') }}</span>
                                        </p><p  style="font-size: 18px; color: #808080; margin: 0;"> <span>{{$payment->transaction_id}}</span></p>
                                           
        
                                    </div>
                                    <div class="trasaction" style="margin-top: 20px;">
                                        <h5 style="margin: 0; color: #666666; font-size: 18px;font-weight: 600;">Payment method</h5>
                                        <p style="font-size: 18px; color: #808080; margin: 0;">{{$payment->payment_method}}</p>
