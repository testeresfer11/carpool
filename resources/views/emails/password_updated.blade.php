    ...
    <div class="welcome-email">
        <div class="container" style="max-width: 500px; margin:0 auto">
            <table style="width: 100%;">
                <thead>
                    <tr>
                        <th style="font-size: 40px;color: #7dbf43;text-align: left;font-weight: 600;">Drivvy</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20;font-weight: 600;">Your password has been updated.</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                             <p style="font-size: 18px; color: #808080;">{!!$content!!}</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">If you have not made this change. Please, contact us by responding to this email.</p>
                        </td>
                    </tr>
                      <tr>
