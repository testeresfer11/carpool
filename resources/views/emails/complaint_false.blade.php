        ...
        <div class="container" style="max-width: 500px; margin:0 auto">
            <table style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">We have thoroughly reviewed the complaint  you made against the driver for your ride and found it false.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">As a result, we'll not be providing you with a refund. We apologize for any inconvenience this may have caused. </p>
