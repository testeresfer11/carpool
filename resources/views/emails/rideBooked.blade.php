                    ...
                    <tr>
                        <td>
                            <div class="booking" style="margin:25px 0;">
                                <p style="font-size: 20px; color: #666666;margin: 0;font-weight: 500;">Booking</p>
                    ...
                    {{--<tr>
                        <td style="text-align: center;">
                            <div class="total-pass" style="margin:30px 0;">
                                <span style="margin: 0; color: #666666; font-size: 18px;">Total paid by the passenger</span><span
                                    style="margin: 0; color: #666666; font-size: 18px;font-weight: 700;padding-left: 30px;">${{ number_format($amount, 2) }}</span>
                            </div>
                        </td>
                    </tr>--}}
                      <tr>
