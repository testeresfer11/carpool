...
<head>
    ...
    <style>
        ...
        .airport-text .melb-text,
        .airport-text .charle-text {
            margin-bottom: 20px;
        }
            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style="color: #231f20;  font-weight: 600;">Unfortunately, {{$user->first_name}} can’t take you anymore. We refunded you.   </h1>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">{{ \Carbon\Carbon::parse($ride->departure_time)->format('l, d F Y') }}</p>
                        </td>
                    </tr>
 <!-- First Location -->
                            <tr>
                    ...
                    <tr>
                        <td style="padding-top: 30px;padding-bottom: 30px; text-align: center;">
                            <p style="font-size: 18px; color: #808080;">Find a new available ride in the Drivvy app.</p>
                        </td>
                    </tr>
