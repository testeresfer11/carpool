            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="margin-top: 20px; display: block;">
                        <td>
                            <h1 style=" max-width:522px;color: #231f20; font-weight: 600;">Your email verification code</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">Your email verification code is:<strong style="padding-left: 10px;">{{ $otp }}</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;margin: 0;">Please, use this code to verify your email address.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;"> This code is valid for 10 minutes.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="margin-bottom: 40px;font-size: 18px; color: #808080;background-color: #f9f9f9; padding: 30px;">If you did not request this email verification code, please ignore this email.</p>
                        </td>
                    </tr>
                      <tr>
