...
use App\Http\Controllers\admin\{AuthController,DashboardController,UserController,RideController,RequestController,ReviewsController,ReportController,GeneralController,MessageController,VechileController,DocumentController,PolicyController, CarsController,FareController,ContentController,RewardController};
        ...
        Route::get('/revenue-chart-data', [DashboardController::class, 'getrevenueChartData'])->name('revenue-chart-data');
            ...
            Route::group(['prefix' =>'settings'],function () {
                Route::name('settings.')->group(function () {
                    ...
                    Route::get('rewards',[RewardController::class, 'reward'])->name('reward.list');
                    Route::match(['get', 'post'],'rewards/add',[RewardController::class, 'addReward'])->name('reward.add');
                    Route::match(['get', 'post'],'rewards/edit/{id}',[RewardController::class, 'editReward'])->name('reward.edit');
                    Route::get('rewards/delete/{id}',[RewardController::class, 'delete'])->name('reward.delete');
